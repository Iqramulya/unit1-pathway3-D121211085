...
fun MiddlePart() {
    ...
    Column(
        ...
        Text(text = "Muh. Iqra Mulya Gading", fontSize = 30.sp, modifier = Modifier.padding(top = 16.dp))
    ...
    Tugas1Theme {
        ...
        MiddlePart()
            Column(
                ...
                DataRow(text = "@Iqramulya", icon = Icons.Default.Share)
                DataRow(text = "gadingiqra@gmail.com", icon = Icons.Default.Email)
            }
        }
    }
}